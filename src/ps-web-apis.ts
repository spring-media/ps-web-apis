...
export interface WhoamiV1 {
     ...
     */
    authorizedFetch: (input: RequestInfo, init?: FetchOptions) => Promise<Response>;
    /**
     * Expose custom fetch instance with timeout possibilities via init.timeout
     */
    nonAuthorizedFetch: (input: RequestInfo, init?: FetchOptions) => Promise<Response>;
    /**
